 ...
 *
 * Updated May 29, 2026:
 * In a tragic twist of fate, we ended up not really using this script since we don't have win/lose
 * conditions in the current version.
 * I commented out all the lines because I removed some functions from the level manager that it tries 
 * to call.
 * - Graydon Bruyn
 */
